...
- **Responsive** – Clean layout across different screen sizes
...
1. Clone the repository:
   ```bash
   git clone https://github.com/shravan-sankar/shravan-sankar.github.io.git
   cd shravan-sankar.github.io
   ```
...
© 2026 Shravan Sankar. All rights reserved.
